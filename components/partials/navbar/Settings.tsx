                ...
                >
                  {languages.map((lang, langIdx) => (
                    <Listbox.Option
                      key={langIdx}
                      className={({ active }) =>
                        `relative  cursor-pointer select-none font-normal ${
                    ...
                    >
                      {({ selected }) => (
                        <>
                          <span
                            className={`block hover:bg-primary-blue-color/[0.6] rounded-lg p-2 truncate ${
                              selected
                                ? "font-medium bg-primary-blue-color"
                                : "font-normal"
                            }`}
                          >
                            {lang.name}
